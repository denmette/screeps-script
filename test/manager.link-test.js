...
describe("manager.link", () => {
  it("exists", () => {
    ...
    assert.equal(
      startsWith,
      LinkManager.toString().substring(0, startsWith.length),
    );
  });
  ...
  describe("#runLink", () => {
    ...
    it("with debug", () => {
      ...
      assert.equal(
        "💫 transfering resources from SOURCE to TARGET",
        info.getLine(0),
      );
    });
  ...
  describe("#runLinks", () => {
    ...
    it("default", () => {
      ...
      sourceLink2.transferEnergy = (t) =>
        assert.fail("SOURCE2 should not transfer ennergy!");
      sourceLink3.transferEnergy = (t) =>
        assert.fail("SOURCE3 should not transfer ennergy!");

      var manager = new LinkManager(room);
      manager._findSourceLinks = () => [sourceLink1, sourceLink2, sourceLink3];
      manager._findTargetLink = (source) =>
        sourceLink1 == source ? targetLink : null;
      manager.runLinks();
