...
describe("role.courier", () => {
  ...
  it("constructor", () => {
    ...
    assert.equal(
      startsWith,
      Courier.toString().substring(0, startsWith.length),
    );
  ...
  describe("#findTargets", () => {
    ...
    it("no structure found", () => {
      ...
      assert.equal(
        "🛑 R2 could not find game object with ID: undefined",
        info.getLine(0),
      );
    });
  });
  ...
  describe("#findSources", () => {
    ...
    it("no structure found", () => {
      ...
      assert.equal(1, info.getLines().length);
      assert.equal(
        "🛑 R1 could not find game object with ID: 67890",
        info.getLine(0),
      );
    });
  });
  ...
  describe("#findById", () => {
    ...
    it("no structure found", () => {
      ...
      assert.equal(1, info.getLines().length);
      assert.equal(
        "🛑 R3 could not find game object with ID: 74102",
        info.getLine(0),
      );
    });
  });
