...
describe("role.protoype", () => {
  ...
  it("exists", () => {
    ...
    assert.equal(
      startsWith,
      RolePrototype.toString().substring(0, startsWith.length),
    );
  });
  ...
  describe("#replicateParts", () => {
    ...
    it("2 parts x 2", () => {
      ...
      assert.deepEqual(
        [MOVE, WORK, MOVE, WORK],
        object._replicateParts([MOVE, WORK], 2),
      );
    });
  });
  ...
  describe("#calculateMaxParts", () => {
    ...
    it("2 parts 0 single => 1", () => {
      ...
      assert.deepEqual(
        [MOVE, MOVE],
        object._calculateMaxParts(spawn, [MOVE, MOVE]),
      );
    });
    ...
    it("1 parts 1 single => 1", () => {
      ...
      assert.deepEqual(
        [ATTACK, MOVE],
        object._calculateMaxParts(spawn, [MOVE], [ATTACK]),
      );
    });
    ...
    it("2 parts 1 single => 0", () => {
      ...
      assert.equal(
        null,
        object._calculateMaxParts(spawn, [MOVE, MOVE], [ATTACK]),
      );
    });
    ...
    it("1 parts 2 single => 2", () => {
      ...
      assert.deepEqual(
        [ATTACK, WORK, MOVE, MOVE],
        object._calculateMaxParts(spawn, [MOVE], [ATTACK, WORK]),
      );
    });
    ...
    it("2 parts 2 single => 0", () => {
      ...
      assert.equal(
        null,
        object._calculateMaxParts(spawn, [MOVE, MOVE], [ATTACK, WORK]),
      );
    });
    ...
    it("2 parts 2 single => 2", () => {
      ...
      assert.deepEqual(
        [ATTACK, WORK, MOVE, MOVE, MOVE, MOVE],
        object._calculateMaxParts(spawn, [MOVE, MOVE], [ATTACK, WORK]),
      );
    });
  });
  ...
  describe("#spawnCreepWithParts", () => {
    ...
    it("plus single => no creep", () => {
      ...
      var creep = object._spawnCreepWithParts(
        spawn,
        [WORK, MOVE, CLAIM],
        [CLAIM],
      );
  ...
  describe("#sortTargetForClosest", () => {
    it("multiple", () => {
      ...
      assert.deepEqual(
        ["B", "A", "C"],
        object._sortTargetForClosest(["A", "B", "C"], creep),
      );
    });
  });
  ...
  describe("#sortSourceForClosest", () => {
    it("multiple", () => {
      ...
      assert.deepEqual(
        ["B", "A", "C"],
        object._sortSourceForClosest(["A", "B", "C"], creep),
      );
    });
  });
  ...
  describe("#commuteBetweenSourceAndTarget", () => {
    it("lifecycle", () => {
      ...
      object._commuteBetweenSourceAndTarget(creep, (target) =>
        assert.fail("Creep should not work yet!"),
      );
      ...
      object._commuteBetweenSourceAndTarget(creep, (target) =>
        assert.fail("Creep should not work anymore!"),
      );
  ...
  describe("#run", () => {
    ...
    it("pickup energy", () => {
      ...
      creep.pos.findInRange = (type) =>
        type == FIND_DROPPED_RESOURCES ? [droppedEnergy] : [];

      var object = new RolePrototype();

      // dropped energy is far away, so go there
      creep.pickup = (resource) =>
        resource == droppedEnergy ? ERR_NOT_IN_RANGE : -1;
      object._work = (workingCreep) =>
        assert.fail("Creep cannot work while moving!");
    ...
    it("loot tombstone", () => {
      ...
      creep.pickup = (resource) =>
        resource == tombstone ? ERR_NOT_IN_RANGE : -1;
      object._work = (workingCreep) =>
        assert.fail("Creep cannot work while looting!");
  ...
  describe("TARGET_MODE_X", () => {
    var setupRolePrototype = function (targetMode) {
      ...
      assert.equal(
        targetB,
        object._findClosestTarget(new Creep("TARGET_MODE_X")),
      );
      return object;
    };
    ...
    describe("USE_IF_VALID", () => {
      describe("#findClosestTarget", () => {
        it("target found", () => {
          ...
          var object = setupRolePrototype(
            RolePrototype.TARGET_MODE_USE_IF_VALID,
          );
        ...
        it("target not found", () => {
          ...
          assert.equal(1, info.getLines().length);
          assert.equal(
            "🛑 TARGET_MODE_USE_IF_VALID could not find target: E",
            info.getLine(0),
          );
        });
      });
    ...
    describe("USE_OR_WAIT", () => {
      describe("#findClosestTarget", () => {
        it("target found", () => {
          ...
          var object = setupRolePrototype(
            RolePrototype.TARGET_MODE_USE_OR_WAIT,
          );
        ...
        it("target not found", () => {
          ...
          assert.equal(1, info.getLines().length);
          assert.equal(
            "🛑 TARGET_MODE_USE_OR_WAIT could not find target: E",
            info.getLine(0),
          );
        });
      });
    ...
    describe("USE_OR_ERROR", () => {
      describe("#findClosestTarget", () => {
        it("target found", () => {
          ...
          var object = setupRolePrototype(
            RolePrototype.TARGET_MODE_USE_OR_ERROR,
          );
        ...
        it("target not valid", () => {
          ...
          assert.equal(1, info.getLines().length);
          assert.equal(
            "🛑 TARGET_MODE_USE_OR_ERROR could not find target in list: D",
            info.getLine(0),
          );
        });
        ...
        it("target not found", () => {
          ...
          assert.equal(1, info.getLines().length);
          assert.equal(
            "🛑 TARGET_MODE_USE_OR_ERROR could not find target: E",
            info.getLine(0),
          );
        });
      });
  ...
  describe("SOURCE_MODE_X", () => {
    var setupRolePrototype = function (sourceMode) {
      ...
      assert.equal(
        sourceB,
        object._findClosestSource(new Creep("SOURCE_MODE_X")),
      );
      return object;
    };
    ...
    describe("USE_IF_VALID", () => {
      describe("#findClosestSource", () => {
        it("source found", () => {
          ...
          var object = setupRolePrototype(
            RolePrototype.SOURCE_MODE_USE_IF_VALID,
          );
        ...
        it("source not found", () => {
          ...
          assert.equal(1, info.getLines().length);
          assert.equal(
            "🛑 SOURCE_MODE_USE_IF_VALID could not find source: E",
            info.getLine(0),
          );
        });
      });
    ...
    describe("USE_OR_WAIT", () => {
      describe("#findClosestSource", () => {
        it("source found", () => {
          ...
          var object = setupRolePrototype(
            RolePrototype.SOURCE_MODE_USE_OR_WAIT,
          );
        ...
        it("source not found", () => {
          ...
          assert.equal(1, info.getLines().length);
          assert.equal(
            "🛑 SOURCE_MODE_USE_OR_WAIT could not find source: E",
            info.getLine(0),
          );
        });
      });
    ...
    describe("USE_OR_ERROR", () => {
      describe("#findClosestSource", () => {
        it("source found", () => {
          ...
          var object = setupRolePrototype(
            RolePrototype.SOURCE_MODE_USE_OR_ERROR,
          );
        ...
        it("source not valid", () => {
          ...
          assert.equal(1, info.getLines().length);
          assert.equal(
            "🛑 SOURCE_MODE_USE_OR_ERROR could not find source in list: D",
            info.getLine(0),
          );
        });
        ...
        it("source not found", () => {
          ...
          assert.equal(1, info.getLines().length);
          assert.equal(
            "🛑 SOURCE_MODE_USE_OR_ERROR could not find source: E",
            info.getLine(0),
          );
        });
      });
